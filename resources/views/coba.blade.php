            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href="{{ route('jenis_barang.index') }}"><i class="fa fa-flask nav_icon"></i>Ketegori Produk</a>
                        </li>
                        <li>
                            <a href="{{ route('barang.index') }}"><i class="fa fa-flask nav_icon"></i>Produk</a>
                        </li>
                        <li>
        ...
        <div class="graphs">
          ...
          <div class="col-sm-3 widget_1_box">
            <div class="r3_counter_box">
                    ...
                    <div class="stats">
                      <h5><strong>
                      </strong>Jumlah Terjual{{ $data->total_sales }}</h5>
                     <!--  @foreach($rekap2 as $dat)
                      @if($data->id_jenis_barang==$dat->id_jenis_barang)
                        <span>{{ $dat->nama_jenis_barang }}</span>
                      @endif
                      @endforeach
                    </div> -->
                </div>
